...
class Board extends React.Component
{
  ...
  renderArray(arrayVal, index) {
    ...
    if (this.state.gSize == 2340) {
      return (
        <div ref={cellId} onClick={() => this.refs[cellId].style.background = "white"} className='unitTwo'></div>
      )
    } else if (this.state.gSize == 4160) {
      return (
        <div ref={cellId} onClick={() => this.refs[cellId].style.background = "white"} className='unitThree'></div>
      )
    } else
      return (
        <div ref={cellId} onClick={() => this.refs[cellId].style.background = "white"} className='unitOne'></div>
      )
  }
  drawer(squares)
  {
  ...
  birthCell()
  {
    ...
    var borderCell = 0;
    var startCell = [];
    if (this.state.gSize == 1040) {
      borderCell = 40;
    } else if (this.state.gSize == 2340) {
      borderCell = 60;
    } else if (this.state.gSize == 4160) {
      borderCell = 80;
    }
  ...
  greenCell(neighbours, cell)
  {
    ...
    var cellColor = '';
    var neiColor = '';
    var newVal = this.state.generation;
  ...
  render() {
    ...
    return (
      <body><br/>
        Select
        <DropdownButton bsSize="small" bsStyle="info" title="Grid Size" id="bg-nested-dropdown">
